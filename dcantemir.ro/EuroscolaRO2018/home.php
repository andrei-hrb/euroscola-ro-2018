...
<div class="container" id="spacingtop">
    ...
    <div class="featurette">
        <div class="row">
            <div class="col-md-7 order-0">
                ...
                <p class="lead " style="text-indent: 30px;"><?= $threeText ?></p>
                <p class="lead " style="text-indent: 30px;"><?= $threeText2 . $threeText3 ?></p>
            </div>
    ...
    <div class="row featurette">
        <div class="col-md-7 order-0">
            ...
            <p class="lead"> <?= $sevenText1 . ' (il vei gasii asociat pe pagina)'?></p>
        </div>
        <div class="col-md-5 order-1">
            <div class="mx-auto text-center">
