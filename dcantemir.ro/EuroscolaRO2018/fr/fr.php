...
$facebookText = "Aussi, vous pouvez nous contacter sur la page Facebook, où nous postons régulièrement et nous tenons au courant les utilisateurs en ce qui concerne la campagne. ";
$facebookText1 = "Si vous voulez trouver plusieurs informations des participants du projet, vous pouvez accéder à notre groupe Facebook (îl vei găsi asociat cu pagina noastră de Facebook).";
