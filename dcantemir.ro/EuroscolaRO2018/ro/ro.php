...
//Home -> Euroscola
$euroscolaTitle = "Ce este Euroscola?";
$euroscolaText = "Parlamentul European a creat programul Euroscola pentru a informa tinerii despre procesul de integrare europeană și pentru a promova participarea lor la construcția Uniunii Europene. Programul reunește periodic elevi de liceu din cele 28 de state membre, oferindu-le ocazia, pe parcursul unei zile, de a afla cum funcționează Parlamentul European, de a se cunoaște între ei, de a-și împărtăși viziunile și așteptările.";
...
$facebookText = "Ne puteți contacta si pe pagina de Facebook, unde postăm regulat și ținem la curent utilizatorii în legătură cu campania. ";
$facebookText1 = "În cadrul acestei pagini este și un grup, unde pot intra cei care vor să afle mai multe de la participanții proiectului (îl vei găsi asociat cu pagina noastră de Facebook).";
...
//Footer
$footText = "Site creat pentru Concursul național EUROSCOLA, ediția a XI-a (2018-2019) ca parte din materialul de promovare al Erasmus+.";
